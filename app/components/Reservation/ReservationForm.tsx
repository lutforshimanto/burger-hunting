...
const ReservationForm = () => {
  return (
    <div className="bg-green-700 p-6 rounded-lg">
      ...
      <h1 className="text-center font-bold uppercase text-[30px] md:text-[40] lg:text-[50px] mt-[0.5rem] text-white">
        Reservation
      </h1>
      ...
      <div className="mt-[2rem]">
        <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 items-center w-[80%] mx-auto justify-between space-x-4">
          <select
            className="px-10 py-2.5 bg-transparent rounded-none outline-none font-bold text-[17px] text-white border-[2.2px] border-gray-100"
            name="people"
            id="people"
          >
        ...
        <div className="mt-[2rem] w-[80%] text-center mx-auto">
          <button className="px-8 py-3 rounded-lg md-[3rem] text-[16px] w-full bg-blue-950 transition-all duration-200 hover:bg-red-700 text-white">
            Book Now
          </button>
        </div>
      </div>
